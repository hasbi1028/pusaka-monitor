...
<Toast />
<Sidebar {activePage} bind:toggleDrawer={toggleDrawerFn} />
<div class="lg:pl-48 min-h-screen pb-16 lg:pb-0 flex flex-col">
  <Topbar {title} onToggleDrawer={() => toggleDrawerFn()} />
  <main class="p-2.5 page-enter flex-1">
    {@render children()}
  </main>
